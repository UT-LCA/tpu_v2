...
addi	r31, r0, 31					# set vector length
vmstc	VL, r31
...
.set noat # turn off assembler optimization warnings
# change vector length
addi	r31, r0, 24					# set vector length
vmstc	VL, r31
...
# change vector length
addi	r31, r0, 8					# set vector length
vmstc	VL, r31
vadd.vs		v5, v5, r1
...
.set noat # turn off assembler optimization warnings
# change vector length
addi	r31, r0, 9					# set vector length
vmstc	VL, r31
...
# change vector length
addi	r31, r0, 7					# set vector length
vmstc	VL, r31
